...
public class WalletHelper {
  ...
  public static final String DEFAULT_HOME_DIR_PATH = SystemUtils.getUserHome() + File.separator + HOME_DIRNAME;
  public static final String DEFAULT_WALLET_PATH = DEFAULT_HOME_DIR_PATH + File.separator + WALLET_FILENAME;
